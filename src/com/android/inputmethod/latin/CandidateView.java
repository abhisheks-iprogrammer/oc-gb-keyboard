...
public class CandidateView extends View {
    ...
    public CandidateView(Context context, AttributeSet attrs) {
        ...
        mPreviewText = (TextView) inflate.inflate(Theme.adjust(Theme.LAYOUT, R.layout.candidate_preview), null);
        mPreviewPopup.setWindowLayoutMode(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        mPreviewPopup.setContentView(mPreviewText);
        mPreviewPopup.setBackgroundDrawable(null);
        mPreviewPopup.setAnimationStyle(R.style.KeyPreviewAnimation);
        mColorNormal = res.getColor(Theme.adjust(Theme.COLOR, R.color.candidate_normal));
        mColorRecommended = res.getColor(Theme.adjust(Theme.COLOR, R.color.candidate_recommended ));
        mColorOther = res.getColor(Theme.adjust(Theme.COLOR, R.color.candidate_other ));
