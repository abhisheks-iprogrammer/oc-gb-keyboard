...
public class LatinIME extends InputMethodService
    ...
    private static final String PREF_SHOW_SUGGESTIONS_LIST = "show_suggestions_list";
    ...
    private HardKeyRemap mHardKeyRemap;
    ...
    private String mShowSuggestionsMode;
    ...
    public void onCreate() {
        ...
        mHardKeyRemap = new HardKeyRemap(this);
                ...
                if (current == XmlResourceParser.START_TAG) {
                    ...
                    if (tag != null) {
                        if (tag.equals("part")) {
                            ...
                            dictionaries.add(res.getIdentifier(dictFileName, "raw", "mobi.pruss.android.inputmethod.latin"));
                        }
                    }
                }
                xrp.next();
    ...
    public View onCreateCandidatesView() {
        ...
        mCandidateViewContainer = (LinearLayout) getLayoutInflater().inflate(  
        		Theme.adjust(Theme.LAYOUT, R.layout.candidates_red), null);
    ...
    public void onStartInputView(EditorInfo attribute, boolean restarting) {
        boolean forcePrediction = PreferenceManager.getDefaultSharedPreferences(this).getString(PREF_SHOW_SUGGESTIONS_LIST, 
        		getString(R.string.show_suggestions_default)).equals(getString(R.string.show_suggestions_always));
        ...
        mPredictionOn = mPredictionOn && (mCorrectionMode > 0 || 
        		! mShowSuggestionsMode.equals(R.string.show_suggestions_never));
    ...
    private boolean isCandidateStripVisible() {
        return isPredictionOn() && ! mShowSuggestionsMode.equals(getString(R.string.show_suggestions_never));
    }
    ...
    private void loadSettings() {
        ...
        mShowSuggestionsMode = sp.getString(PREF_SHOW_SUGGESTIONS_LIST, 
        		getString(R.string.show_suggestions_default));
        ...
        mAutoCorrectEnabled = sp.getBoolean(PREF_AUTO_COMPLETE,
                ...
                ! mShowSuggestionsMode.equals(getString(R.string.show_suggestions_never));
