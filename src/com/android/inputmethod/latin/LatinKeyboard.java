...
public class LatinKeyboard extends Keyboard {
    ...
    public LatinKeyboard(Context context, int xmlLayoutResId, int mode) {
        ...
        mMode = mode;
        mRes = res;
        mShiftLockIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_shift_locked);
        mShiftLockPreviewIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_feedback_shift_locked);
        setDefaultBounds(mShiftLockPreviewIcon);
        mSpaceIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_space);
        mSpaceAutoCompletionIndicator = Theme.getDrawable(res, R.drawable.sym_keyboard_space_led);
        mSpacePreviewIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_feedback_space);
        mMicIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_mic);
        mMicPreviewIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_feedback_mic);
        setDefaultBounds(mMicPreviewIcon);
        mButtonArrowLeftIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_language_arrows_left);
        mButtonArrowRightIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_language_arrows_right);
        m123MicIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_123_mic);
        m123MicPreviewIcon = Theme.getDrawable(res, R.drawable.sym_keyboard_feedback_123_mic);
        mHintIcon = Theme.getDrawable(res, R.drawable.hint_popup);
        setDefaultBounds(m123MicPreviewIcon);
        sSpacebarVerticalCorrection = res.getDimensionPixelOffset(
                R.dimen.spacebar_vertical_correction);
        mIsAlphaKeyboard = xmlLayoutResId == R.xml.kbd_qwerty
                || xmlLayoutResId == R.xml.kbd_qwerty_black 
                || xmlLayoutResId == R.xml.red_kbd_qwerty
                || xmlLayoutResId == R.xml.red_kbd_qwerty_black;
            ...
            switch (options&(EditorInfo.IME_MASK_ACTION|EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
                ...
                default:
                    if (mode == KeyboardSwitcher.MODE_IM) {
                        ...
                        mEnterKey.iconPreview = Theme.getDrawable(res, 
                        		R.drawable.sym_keyboard_feedback_return);
                        mEnterKey.icon = Theme.getDrawable(res,
                        		mIsBlackSym ?
    ...
    public void setColorOfSymbolIcons(boolean isAutoCompletion, boolean isBlack) {
        mIsBlackSym = isBlack;
        if (isBlack) {
            mShiftLockIcon = Theme.getDrawable(mRes, R.drawable.sym_bkeyboard_shift_locked);
            mSpaceIcon = Theme.getDrawable(mRes, R.drawable.sym_bkeyboard_space);
            mMicIcon = Theme.getDrawable(mRes, R.drawable.sym_bkeyboard_mic);
            m123MicIcon = Theme.getDrawable(mRes, R.drawable.sym_bkeyboard_123_mic);
        } else {
            mShiftLockIcon = Theme.getDrawable(mRes, R.drawable.sym_keyboard_shift_locked);
            mSpaceIcon = Theme.getDrawable(mRes, R.drawable.sym_keyboard_space);
            mMicIcon = Theme.getDrawable(mRes, R.drawable.sym_keyboard_mic);
            m123MicIcon = Theme.getDrawable(mRes, R.drawable.sym_keyboard_123_mic);
        }
        updateDynamicKeys();
        if (mSpaceKey != null) {
    ...
    private void updateF1Key() {
        ...
        if (mIsAlphaKeyboard) {
            if (mMode == KeyboardSwitcher.MODE_URL) {
                setNonMicF1Key(mF1Key, "/", Theme.adjust(Theme.XML, R.xml.popup_slash));
            } else if (mMode == KeyboardSwitcher.MODE_EMAIL) {
                setNonMicF1Key(mF1Key, "@", Theme.adjust(Theme.XML, R.xml.popup_at));
            } else {
                if (mVoiceEnabled && mHasVoiceButton) {
                    setMicF1Key(mF1Key);
                } else {
                    setNonMicF1Key(mF1Key, ",", Theme.adjust(Theme.XML, R.xml.popup_comma));
                }
            }
    ...
    private void updateSpaceBarForLocale(boolean isAutoCompletion, boolean isBlack) {
        ...
        if (mLocale != null) {
            ...
            if (isAutoCompletion) {
                ...
                mSpaceKey.icon = Theme.getDrawable(mRes, 
                		isBlack ? R.drawable.sym_bkeyboard_space : R.drawable.sym_keyboard_space);
            }
        }
    }
    ...
    class SlidingLocaleDrawable extends Drawable {
        ...
        public SlidingLocaleDrawable(Drawable background, int width, int height) {
            ...
            mLeftDrawable =
                    Theme.getDrawable(mRes, R.drawable.sym_keyboard_feedback_language_arrows_left);
            mRightDrawable =
                    Theme.getDrawable(mRes, R.drawable.sym_keyboard_feedback_language_arrows_right);
